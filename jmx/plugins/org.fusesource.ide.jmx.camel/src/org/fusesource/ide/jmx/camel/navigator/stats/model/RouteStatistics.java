...
public class RouteStatistics implements IProcessorStatistics {
	private String id;
	...
	private ArrayList<ProcessorStatistics> processorStatisticsList;



	@Override
	public String toString() {
		return "RouteStatistics(" + getId() + " completed: " + exchangesCompleted + ")";
	}
	...
	/**
	 * @return the processorStatisticsList
	 */
	@XmlElementWrapper(name = "processorStats")
	@XmlElement(name = "processorStat")
	public ArrayList<ProcessorStatistics> getProcessorStatisticsList() {
		return this.processorStatisticsList;
	}

	/**
	 * @param processorStatisticsList the processorStatisticsList to set
	 */
	public void setProcessorStatisticsList(
			ArrayList<ProcessorStatistics> processorStatisticsList) {
		this.processorStatisticsList = processorStatisticsList;
	}
